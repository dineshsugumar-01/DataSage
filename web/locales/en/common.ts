export const CommonEn = {
  ...
  data_center_desc:
    'DataSage also offers a user-friendly data center management interface for efficient data maintenance.',
  ...
  dbgpts_community: 'DataSageS Community',
  community_dbgpts: 'Community DataSageS',
  my_dbgpts: 'My DataSageS',
  ...
  home_title: 'DataSage AI Data Assistant',
  ...
  'request.error.network':
    'Cannot connect to DataSage service: network unreachable (possibly CORS restriction or service not running). Please check cors_allowed_origins config and whether the service is up.',
