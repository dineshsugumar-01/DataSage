...
const pluginViewStatusMapper: Record<DataSageView['status'], { bgClass: string; icon: React.ReactNode }> = {
  todo: {
    bgClass: 'bg-gray-500',
...
const ChatContent: React.FC<{
  ...
  const { value, cachePluginContext } = useMemo<{
    relations: string[];
    value: string;
    cachePluginContext: DataSageView[];
  }>(() => {
