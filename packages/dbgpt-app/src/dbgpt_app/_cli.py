...
_BANNER_ART = """\
  ...
  | | | |/ _` | __/ _` \\___ \\ / _` |/ _` |/ _ \\ 
  | |_| | (_| | || (_| |___) | (_| | (_| |  __/ 
  |____/ \\__,_|\\__\\__,_|____/ \\__,_|\\__, |\\___| 
                                    |___/       \
"""


def _print_banner() -> None:
    """Print the DataSage ASCII art banner to the terminal."""
    from dbgpt.util.console.console import CliLogger

    _log = CliLogger()
    _log.print(f"[bold cyan]{_BANNER_ART}[/bold cyan]")
    _log.print("")
    _log.print("   [dim]🚀 DataSage Quick Start[/dim]")
    _log.print("")
